      ...
      {show && (
        <div
          ...
          style={{
            ...
            top: ref.current
              ? posBelow
                ? ref.current.getBoundingClientRect().bottom + 10
                : ref.current.getBoundingClientRect().top - 230
              : 0,
            left: ref.current
              ? ref.current.getBoundingClientRect().left +
                ref.current.getBoundingClientRect().width / 2 - 115
              : 0,
            zIndex: 9999,
            padding: 5,
          ...
          {filtered.map(c => {
            ...
            return (
              ...
              >
                ...
                {/* Top section — clickable to profile */}
                <div
                  onClick={() => navigate(`/contacts/${c.id}`)}
                  style={{
                    display: 'flex',
                ...
                <div style={{
                  ...
                  <Link
                    to={`/conversations/new?contact=${c.id}`}
                    className="btn btn-muted"
                    style={{ padding: '8px 12px', justifyContent: 'center' }}
                  >
                    💬 Note
                  ...
                  <button
                    type="button"
                    onClick={e => handleDelete(e, c.id, c.primary_username)}
